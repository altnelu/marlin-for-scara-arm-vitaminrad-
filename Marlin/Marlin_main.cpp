...
{
     delta_tower1_x= -SIN_60*radius;  // front left tower  (A)
     delta_tower1_y= -COS_60*radius;
     delta_tower2_x=  SIN_60*radius;  // front right tower (B)
     delta_tower2_y= -COS_60*radius;
     delta_tower3_x= 0.0;             // back middle tower (C)
...
void calculate_delta(float cartesian[3]){
    ...
    SCARA_pos[X_AXIS] = cartesian[X_AXIS] * axis_scaling[X_AXIS] - SCARA_offset_x;  // Translate cartesian X Y
